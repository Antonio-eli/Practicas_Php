...
<head>
    ...
    <meta content="Desarrollador Backend | HTML, Css, y Php " name="descripción" />
    <meta content="Eliceo Romero Antonio" name="Autor" />

    <!-- App favicon -->
    <link rel="shortcut icon" href="programacion.png">
